...
StaticOrderMISS::StaticOrderMISS(vector<vector<char>> const &vAdjacencyMatrix)
: MISQ(vAdjacencyMatrix)
{
    SetName("static-order-miss");
}

void StaticOrderMISS::InitializeOrder(std::vector<int> &P, std::vector<int> &vVertexOrder, std::vector<int> &vColors)
{
...
void StaticOrderMISS::GetNewOrder(vector<int> &vNewVertexOrder, vector<int> &vVertexOrder, vector<int> const &P, int const chosenVertex)
{
////    cout << "Old order: ";
...
void StaticOrderMISS::ProcessOrderAfterRecursion(std::vector<int> &vVertexOrder, std::vector<int> &P, std::vector<int> &vColors, int const chosenVertex)
{
////    cout << "StaticOrderMISS::ProcessOrderAfterRecursion" << endl;
